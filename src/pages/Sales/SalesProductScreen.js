    ...
    return (
        <SafeAreaView style={styles.mainContainer}>
            <View style={styles.subContainer}>
                ...
                <View style={styles.badgesContainer}>
                    <View style={styles.badge}>
                        <Text style={styles.badgeText}>8 pdç</Text>
                    </View>
                    <LinearGradient 
                        style={styles.badgeActive}
                        colors={['#FFA98D', '#E4643B']}
                    >
                        <Text style={styles.badgeActiveText}>10 pdç</Text>
                    </LinearGradient>

                    <View style={styles.badge}>
                        <Text style={styles.badgeText}>12 pdç</Text>
                    </View>
                </View>
                <View style={{flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 25, paddingVertical: 15, backgroundColor: '#f0f0f0',}}>
                    <Text style={styles.productTitle}>Pizza Suprema</Text>
                    <View style={{flexDirection: 'row', alignItems: 'baseline'}}>
                        ...
                        <Text style={{fontSize: 20, fontWeight: 'bold', marginHorizontal: 10}}>ou</Text>
                        <LinearGradient 
                            style={styles.colorIconContainer}
                            colors={['#FFA98D', '#E4643B']}
                        >
            ...
            <View style={styles.navigation}>
                <View style={{flexDirection: 'row', alignItems: 'baseline'}}>
                    <Text style={{color: 'white', fontWeight: 'bold', fontSize: 20}}>R$ </Text>
                    <Text style={{color: 'white', fontWeight: 'bold', fontSize: 35}}>35.00</Text>
                </View>
                <View style={{flexDirection: 'row', alignItems: 'baseline'}}>
                <   LinearGradient 
                        style={styles.colorIconContainer}
                    ...
                    <Text style={{color: 'white', fontWeight: 'bold', marginLeft: 5}}>Add ao Carrinho</Text>
                </View>
            </View>
        </SafeAreaView>
    )
